# 1 "d:\\google drive\\_work\\_pocs and demos\\_my demos\\rest_api_prudential_sample\\\\combined_REST_API_Prudential_sample.c"
...
# 1 "d:\\google drive\\_work\\_pocs and demos\\_my demos\\rest_api_prudential_sample\\\\combined_REST_API_Prudential_sample.c" 2
...
# 2 "d:\\google drive\\_work\\_pocs and demos\\_my demos\\rest_api_prudential_sample\\\\combined_REST_API_Prudential_sample.c" 2
...
StartNVCustom(char *srcIPFrom, char *srcIPTo, char *destIPFrom, char *destIPTo, int latency, float packetLoss, float bandwidthIn, float bandwidthOut)
{
	...
	if ((destIPFrom == "") && (destIPTo == ""))
	{
		ret = sprintf(paramsBuffer, "{\"flows\": [{"
				...
				"\"networkScenario\":\"User defined networks\"}}", srcIPFrom, srcIPTo, latency, packetLoss, bandwidthIn, bandwidthOut, _time32());
	}
	else
	{
		...
		ret = sprintf(paramsBuffer, "{\"flows\": [{"
				...
				"\"testName\":\"Prudential-User Defined Test_%d\"," 
				"\"description\":\"User defined NV test for testing backend servers\"," 
				"\"networkScenario\":\"User defined networks\"}}", srcIPFrom, srcIPTo, destIPFrom, destIPTo, latency, packetLoss, bandwidthIn, bandwidthOut, _time32());
	}
...
# 3 "d:\\google drive\\_work\\_pocs and demos\\_my demos\\rest_api_prudential_sample\\\\combined_REST_API_Prudential_sample.c" 2
...
# 4 "d:\\google drive\\_work\\_pocs and demos\\_my demos\\rest_api_prudential_sample\\\\combined_REST_API_Prudential_sample.c" 2
...
# 5 "d:\\google drive\\_work\\_pocs and demos\\_my demos\\rest_api_prudential_sample\\\\combined_REST_API_Prudential_sample.c" 2
...
# 6 "d:\\google drive\\_work\\_pocs and demos\\_my demos\\rest_api_prudential_sample\\\\combined_REST_API_Prudential_sample.c" 2
